spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red> bakachichichndy <Color=/>"):Display()
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Discord : Join さま┊Windy•Hub Community Discord to Get the Latest Information <Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------
...
local Tabs = {
    Discord = Window:AddTab({Title = "H? So", Icon = "https://files.catbox.moe/lqfvwm.png"}),
    Main = Window:AddTab({Title = "Main", Icon = "home"}),
    Setting = Window:AddTab({Title = "Cài Ð?t", Icon = "settings"}),
    Stats = Window:AddTab({Title = "Ch? S?", Icon = "plus-circle"}),
    Player = Window:AddTab({Title = "Player", Icon = "baby"}),
    Teleport = Window:AddTab({Title = "Ð?o", Icon = "palmtree"}),
    Fruit = Window:AddTab({Title = "Trái Cây", Icon = "cherry"}),
    Raid = Window:AddTab({Title = "Raid", Icon = "swords"}),
    Race = Window:AddTab({Title = "T?c V4", Icon = "chevrons-right"}),
    Shop = Window:AddTab({Title = "C?a Hàng", Icon = "shopping-cart"}),
...
do
    ...
    --------------------------------------------------------------------------------------------------------------------------------------------
Tabs.Main:AddToggle("FarmLevel", {
    Title = "Farm Level",
    Description = "AutoFarmLevel",
    Default = _G.AutoLevel or false,
    Callback = function(value)
        ...
        Fluent:Notify({
            Title = "Farm Level",
            Content = "AutoFarmLevel " .. (value and "Enabled" or "Disabled"),
            Duration = 5
        })
    end
})
