"if (game:GetService("CoreGui")):FindFirstChild("SkyHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).SkyHub:Destroy();
...
ImageButton.Image = "rbxassetid://105322127055754";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("SkyHub")).Enabled = not (game.CoreGui:FindFirstChild("SkyHub")).Enabled;
end);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("SkyHub") then
			makefolder("SkyHub");
		end;
		if not isfolder("SkyHub/Library/") then
			makefolder("SkyHub/Library/");
		end;
		if not isfile(("SkyHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("SkyHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("SkyHub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("SkyHub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("SkyHub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local SkyHub = Instance.new("ScreenGui");
	SkyHub.Name = "SkyHub";
	SkyHub.Parent = game.CoreGui;
	SkyHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = SkyHub;
