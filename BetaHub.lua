spawn(function() 
    ...
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Script Sky Beta<Color=/>"):Display()
end)
----------------------------------------------------------------------------------------------------------------------------------------------
...
local Tabs = {
    Discord = Window:AddTab({Title = "info", Icon = "https://files.catbox.moe/lqfvwm.png"}),
    Main = Window:AddTab({Title = "Main", Icon = "home"}),
    Setting = Window:AddTab({Title = "Pengaturan", Icon = "settings"}),
