...
function g.ApplyHoverEffect(button)
    local tweenEnter = e:Create(button, TweenInfo.new(0.15), {BackgroundTransparency = 0.2})
    local tweenLeave = e:Create(button, TweenInfo.new(0.15), {BackgroundTransparency = 0})
    button.MouseEnter:Connect(function() tweenEnter:Play() end)
    button.MouseLeave:Connect(function() tweenLeave:Play() end)
end
