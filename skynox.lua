...
--     warn("❌ This script must only be executed from the offical SkyHub loader")
--         return
--     end
...
-- _G.__userKey = nil
print("✅ Security verification passed. Loading SkyHub...")
...
-- print("--------------------------------------------------------------------------");
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/Dgu-hub/Taraa-Hubb/refs/heads/main/dataskynox.lua")))();
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("SkyHub/Blox Fruits/") then
			makefolder("SkyHub/Blox Fruits/");
		end;
		if not isfile(("SkyHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("SkyHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("SkyHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
	...
	if Update:SaveSettings() then
		if readfile and writefile and isfile and isfolder then
			if not isfile(("SkyHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
				...
				writefile("SkyHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
			end;
		else
			return warn("Status : Undetected Executor");
		end;
